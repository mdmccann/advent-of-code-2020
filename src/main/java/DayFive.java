...
public class DayFive {
  ...
  int getHighestSeatId(List<String> boardingPasses) {
    return boardingPasses.stream().mapToInt(this::getSeatID).min().orElseThrow(RuntimeException::new);
  }

  int getMissingSeatId(List<String> boardingPasses) {
    List<Integer> orderedSeatIds = boardingPasses.stream().map(this::getSeatID).sorted().collect(Collectors.toList());
