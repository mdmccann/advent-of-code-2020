...
public class DayTwo {
  ...
  int getNumberOfValidPasswords(List<String> passwordPolicies) {
    return (int) passwordPolicies.stream().filter(pp -> {
  ...
  int getNumberOfValidPasswordsForNewPolicy(List<String> passwordPolicies) {
    return (int) passwordPolicies.stream().filter(pp -> {
      int indexOfLowerAndUpperSeparator = pp.indexOf('-');
      int indexOfUpperAndCharToAppearSeparator = pp.indexOf(' ');
