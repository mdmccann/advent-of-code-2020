...
public class DayFour {
  ...
  Map<String, Predicate<String>> rules = Map.of(
  ...
  int getNumberOfPassportsWithRequiredFields(List<String> input, Set<String> requiredFields) {
    ...
    for (String pp : input) {
      if (pp.trim().equals("")) {
        ...
        count = requiredFields.size();
      } else {
        for (String keyValue : pp.split("\\s+")) {
          String[] keyValueArr = keyValue.split(":");
          if (requiredFields.contains(keyValueArr[0])) {
            count--;
          }
        }
      }
  ...
  int getNumberOfValidPassports(List<String> input, Set<String> requiredFields) {
    ...
    for (String pp : input) {
      if (pp.trim().equals("")) {
        ...
        for (String keyValue : pp.split("\\s+")) {
          String[] keyValueArr = keyValue.split(":");
          if (requiredFields.contains(keyValueArr[0]) && rules.get(keyValueArr[0]).test(keyValueArr[1])) {
            count--;
          }
        }
      }
